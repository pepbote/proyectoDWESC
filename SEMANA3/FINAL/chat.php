...
<head>
    ...
    <link href="../david/FINAL/css/stylechat.css" rel="stylesheet">
    <link rel="stylesheet" href="../david/FINAL/css/stylesection.css">
    <script src="../david/FINAL/js/scriptchat.js" defer></script>
...
<body>
    ...
    <div id="section-nft">
        <img src="../david/FINAL/img/nft1.png" alt="nft1">
        <div id="vertical"></div>
        <div id="descripcion">
    ...
    <div id="chat-container">
        <div id="chat-box">
            <div class="message-container">
                <img src="../david/FINAL/img/perfil2.png" class="perfil">
        ...
        <div id="chat-send">
            <img src="../david/FINAL/img/porfile.png" class="perfil">
            <form id="form" method="post" action="comentarios.php">
                ...
                <button type="submit" id="submit"><img src="../david/FINAL/img/send.png" alt="send"></button>
            </form>
        </div>
    </div>
